...
from base.views import learning_unit, offer, common, institution, organization, academic_calendar, my_osis, person
...
urlpatterns = [
    ...
    url(r'^learning_units/create(?:/(?P<academic_year_id>[0-9]+))?/$', learning_unit.learning_unit_create, name='learning_unit_create'),
